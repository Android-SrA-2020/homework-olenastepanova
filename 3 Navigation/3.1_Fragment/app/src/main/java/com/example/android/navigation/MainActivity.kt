...
/**
 * Question 1
What are some of the differences between fragments and activities?
Select all the statements that are true.

When creating a fragment, you inflate the layout in the onCreateView() method.
When creating an activity, you inflate the layout in onCreate().


When inflating the layout for either a fragment or an activity,
you can reference the layout as R.layout.layoutname.
...
Use the <fragment> tag to define the place in a layout file where a fragment
is to be inserted.
 */
